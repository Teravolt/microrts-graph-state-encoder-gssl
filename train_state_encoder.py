...
def compute_loss(proj_embedding_s1: torch.Tensor, proj_embedding_s2: torch.Tensor,
                 ...
                 sudent_temp: torch.Tensor, teacher_temp: torch.Tensor):
    """
    ...
    graph_softmax_s1 = F.softmax(proj_embedding_s1 / sudent_temp, dim=-1)
    graph_softmax_s2 = F.softmax(proj_embedding_s2 / sudent_temp, dim=-1)
