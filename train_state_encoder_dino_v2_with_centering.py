...
def compute_loss(proj_embedding_s1: torch.Tensor, proj_embedding_s2: torch.Tensor,
    ...
    graph_softmax_t1 = F.softmax((proj_embedding_t1 - center_val) / teacher_temp, dim=-1)
    graph_softmax_t2 = F.softmax((proj_embedding_t2 - center_val) / teacher_temp, dim=-1)
...
def get_config():
    ...
    parser.add_argument("--center_ema", default=0.9, type=float,
                        help="EMA for centering")
